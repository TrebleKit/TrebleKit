...
class MaterialTheme {
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xff9cc6f9),
      ...
      tertiaryContainer: Color(0xffd2bae0),
