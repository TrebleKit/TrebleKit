...
val BannerContainer: Color = Color(color = 0xA0B71C1C) // 角标背景色
val BannerContent: Color = Color(color = 0xFFFFFFFF) // 角标文字色

val CapsuleContainer: Color = Color(color = 0xff434056) // 胶囊背景填充
